    ...
    return (
        <div className={styles.content_cart}>
            <div className="container">
                <div><Link to='/' className={styles.ahrefmain}>Main Page</Link> / <span
                    className={styles.sspan}>Basket</span></div>
                <div className={styles.title}><h1>Basket</h1></div>
                <div className={styles.row_basket}>
                    ...
                    <div className={styles.total_add}>
                        ...
                        <div className={styles.button}>
                            <button className={styles.btn}><CartIcon/>Check out</button>
                        </div>
                    </div>
                </div>
            </div>
